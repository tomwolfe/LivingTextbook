 ...
 */
export const generatePrompt = (subject, settings, pageNum = null, totalPages = null, previousPageContent = null) => {
 ...
 */
export const generateImagePrompt = (subject, style = 0.5, pageNum = null) => {
 ...
 */
export const generateImagePromptString = (subject, style = 0.5, pageNum = null) => {
 ...
 */
export const generateNegativePrompt = (style = 0.5) => {
 ...
 */
export const getStyleDescription = (style = 0.5) => {
  if (style < 0.3) {
